    ...
    <div className="w-full bg-white py-4 ">
      <div className="w-[92%] md:w-[80%] mx-auto relative ">
        ...
        <div className="absolute inset-0 flex flex-col justify-center gap-y-2 md:gap-y-3 ps-5 sm:ps-8 md:ps-10 pr-5 sm:pr-[45%]">
          <div className="bg-[#F7BD48] text-[#000000] rounded-sm text-xs sm:text-sm text-center py-1 w-fit px-3">{t("Metal Detecting & Amateur Urban Prospecting")}</div>
          <h1 className="text-white font-bold text-xl sm:text-3xl md:text-4xl font-[Playfair_Display] leading-snug">{t("Central Bank Macro-Tracking & Geopolitical Forecasting")}</h1>
