...
//       date: "JUNE 01, 2026",
//       tag: "Bullish",
//       title: "Historic Discoveries Generate Growing Community Interest",
//       description:
//         "New finds continue attracting enthusiasts and treasure hunting communities worldwide.",
//       image: "/metalDetecting/news.jpg",
//     },
//     {
//       category: "PHYSICAL MARKET",
//       date: "JUNE 01, 2026",
...
const HorizontalCard = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/news/sp9`)
      .then(res => res.json())
      .then(data => {
        setMarketNews(data);
        setLoading(false);
