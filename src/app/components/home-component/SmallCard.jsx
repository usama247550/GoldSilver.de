...
const SmallCard = ({ image, title }) => {
  ...
  return (
    <div className="relative h-24 rounded-lg overflow-hidden group cursor-pointer border-2 border-transparent hover:border-[#F7BD48] group-hover:ring-2 group-hover:ring-[#F7BD48] transition-all duration-300">
