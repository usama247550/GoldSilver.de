  ...
  return (
    <div className="w-full bg-white py-4 ">
      <div className=" w-[92%] md:w-[80%] mx-auto relative ">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-r from-black/40 to-transparent rounded-2xl md:rounded-3xl" />
        ...
        <div className="absolute inset-0 flex flex-col justify-center gap-y-2 md:gap-y-3 ps-5 sm:ps-8 md:ps-10 pr-5 sm:pr-[45%]">
          ...
          <h1 className="text-white font-[Playfair_Display] font-bold text-xl sm:text-3xl md:text-4xl leading-snug">
            {t("AI, Semiconductors")} <br /> {t("& Tech-Industrial Demand")}
          </h1>
          <p className="text-white  w-[105%]  text-xs sm:text-sm md:text-md leading-relaxed">
            {t(
