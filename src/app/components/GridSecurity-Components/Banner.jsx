    ...
    <div className="w-full bg-white py-4 ">
      <div className=" w-[92%] mx-auto relative ">
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 ps-10 flex flex-col gap-y-3">
          ...
          <div className="text-[#FFFFFF] font-bold text-5xl font-[Playfair_Display]">
            {t("Green Energy & The")} <br /> {t("Solar Infrastructure Boom")}
          </div>
          <div className="text-[#FFFFFF]  text-md">
            {t(
              "Explore how solar infrastructure, electric vehicles, and climate-tech investments are driving",
            )}{" "}
            <br /> {t("industrial silver demand across global markets.")}
          </div>
        </div>
      </div>
    </div>
