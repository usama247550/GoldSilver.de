...
//                 </span>
//                 <span
//                   className={`text-white text-[10px] px-4 py-1.5 rounded ${
...
//               <h3 className="text-black font-bold font-[Playfair_Display] text-base sm:text-lg md:text-xl mb-1 leading-snug">
//                 {item.headline || item.summary?.slice(0, 80)}
//               </h3>

//               <p className="text-black w-[96%] text-xs sm:text-sm line-clamp-2">
//                 {item.summary}
//               </p>
//             </div>
        ...
        {marketNews.map((item, index) => (
          <NewsCardTrackable item={item} key={index}>
            <div className="flex gap-3 sm:gap-4 py-4 border-b border-gray-100 last:border-none">
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-5">
                  <span className="text-[#B8860B] text-md tracking-wide">PHYSICAL MARKET</span>
                  <span className="text-gray-400 text-xs hidden sm:inline">•</span>
              ...
              <div className="relative md:w-32 md:h-24 w-24 h-32 sm:w-32 sm:h-32 flex-shrink-0 mt-8 sm:mt-8 overflow-hidden rounded-xl">
                <Image src="/newsbanner/img3.webp" alt="gold" fill sizes="(max-width: 768px) 96px, 128px" className="object-cover" />
              </div>
            </div>
          </NewsCardTrackable>
        ))}
