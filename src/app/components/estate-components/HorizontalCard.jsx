...
//       date: "JUNE 01, 2026",
//       tag: "Bullish",
//       title: "Wealth Transfer Planning Gains Importance Among Families",
//       description:
//         "Investors increasingly focus on protecting assets for future generations.",
//       image: "/estate/news.jpg",
//     },
//     {
//       category: "PHYSICAL MARKET",
//       date: "JUNE 01, 2026",
...
const HorizontalCard = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/news/sp4`)
      .then(res => res.json())
      .then(data => {
        setMarketNews(data);
        setLoading(false);
