...
const articleSchema = buildArticleSchema({
  headline: "Selling Luxury Jewelry: Melt Value vs. Resale Value Explained",
  description: "Learn how jewelry resale, melt value, and market pricing affect decisions for sellers, buyers, and precious metals investors.",
  path: "/JewelryResale",
});
  return (
