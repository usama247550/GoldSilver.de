...
//               {t(
//                 "Buy Gold and Silver Coins and Bars – Trusted Physical Bullion",
//               )}
//             </h1>

//             <p className="text-white text-xs sm:text-sm md:text-base leading-relaxed">
//               {t(
//                 "Explore Krügerrand, Goldbarren, and premium coins with transparent pricing and investment insights.",
//               )}
//             </p>
//           </div>
//         </div>
