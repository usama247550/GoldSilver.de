...
//       tag: "Bullish",
//       title:
//         "Rare Coin Auctions Continue Attracting Global Collectors",
//       description:
//         "Strong collector demand supports premium valuations across numismatic markets.",
//       image: "/numismatics/news.jpg",
//     },
//     {
//       category: "PHYSICAL MARKET",
//       date: "JUNE 01, 2026",
...
const HorizontalCard = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/news/sp8`)
      .then(res => res.json())
      .then(data => {
        setMarketNews(data);
        setLoading(false);
